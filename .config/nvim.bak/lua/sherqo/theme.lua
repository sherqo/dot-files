...
function M.setup(opts)
  opts = require("sherqo.config").extend(opts)

  local colors = require("sherqo.colors").setup(opts)
  local groups = require("sherqo.groups").setup(colors, opts)
  ...
  vim.g.colors_name = "sherqo-" .. opts.style
