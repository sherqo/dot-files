...
function M.setup()
  local sherqo = require("sherqo.theme")
  ...
  -- sherqo.setup({ plugins = { all = true } })
  for _, extra in ipairs(names) do
    local info = M.extras[extra]
    local plugin = require("sherqo.extra." .. extra)
    for style, style_name in pairs(styles) do
      local colors, groups, opts = sherqo.setup({ style = style, plugins = { all = true } })
      local fname = extra
      ...
      colors["_upstream_url"] = "https://github.com/folke/sherqo.nvim/raw/main/extras/" .. fname
      colors["_style_name"] = "Tokyo Night" .. style_name
      colors["_name"] = "sherqo_" .. style
      colors["_style"] = style
      print("[write] " .. fname)
