...
-- Standard Neovim file icons
  vim.pack.add { gh 'nvim-tree/nvim-web-devicons' }

  -- Statusline using standard devicons
...
-- ============================================================
-- SECTION 5: SEARCH & NAVIGATION (Telescope) - TODO: work on this section please, mr. sherqo
-- ============================================================
do
  local plugins = {
  ...
  vim.keymap.set('n', '<C-S-f>', builtin.live_grep, { desc = 'Search Text in Project' })
...
do
  ...
  --  See `:help lsp-config` for information about keys and how to configure - TODO: add lsps here
...
do
  ...
  require('conform').setup {
    ...
    formatters_by_ft = { -- TODO: put the amazing js and other langs formatters
      -- rust = { 'rustfmt' },
